...
namespace SPKPemilihanKaryawan.Controllers
{
    ...
    {
        private SPKContext db = new SPKContext();
        ...
        public AccountController(SistemPendukungKeputusanUserManager userManager, SistemPendukungKeputusanSignInManager signInManager )
        {
